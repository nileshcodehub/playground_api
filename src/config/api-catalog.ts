  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: 'Retrieve all feedback comments linked directly to a specific blog post.',
        queryParams: [
          ...
          { name: 'q', type: 'string', required: false, defaultVal: '-', description: 'Search term across comment name, email, and body.' },
          { name: '_sort', type: 'string', required: false, defaultVal: 'id', description: 'Field name to sort by (name, id, email).' },
          { name: '_order', type: 'string', required: false, defaultVal: 'asc', description: 'Sort direction: asc or desc.' },
        ],
        responseExample: {
          data: [
