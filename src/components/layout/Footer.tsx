      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div className="space-y-4 col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-xs text-text-secondary leading-relaxed max-w-sm sm:max-w-md">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-bg-tertiary hover:bg-border-theme text-text-secondary hover:text-text-primary text-xs font-semibold transition-colors"
            ...
            <ul className="space-y-2 text-xs text-text-secondary">
              ...
              <li>
                <Link href="/docs/auth" className="hover:text-accent-primary transition-colors flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-emerald-400 font-semibold">JWT Bearer</span>
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3 col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2 text-xs text-text-secondary">
              <li>
        ...
        <div className="pt-6 border-t border-border-theme flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-text-muted">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-mono font-semibold hover:bg-emerald-500/20 transition-colors"
            >
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              API Status: Operational
            </a>

            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-bg-tertiary text-[11px] font-mono font-medium text-text-secondary border border-border-theme">
