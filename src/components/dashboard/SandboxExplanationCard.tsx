    ...
    <div className="p-6 rounded-2xl glass-panel border border-border-theme space-y-6 shadow-xl relative overflow-hidden">
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-start gap-4">
          <div className="w-7 h-7 rounded-full bg-emerald-500 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm mt-0.5">
            1
          </div>
        ...
        {/* Step 2 */}
        <div className="flex items-start gap-4">
          <div className="w-7 h-7 rounded-full bg-amber-500 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm mt-0.5">
            2
          </div>
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-text-primary">
        ...
        {/* Step 3 */}
        <div className="flex items-start gap-4">
          <div className="w-7 h-7 rounded-full bg-indigo-500 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm mt-0.5">
            3
          </div>
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-text-primary">
      ...
      {/* Footer Info Bar */}
      <div className="p-3.5 rounded-xl bg-bg-tertiary border border-border-theme flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-text-secondary font-medium">
