  ...
  return (
    <div className="space-y-10 w-full max-w-none">
      ...
      <div className="p-6 rounded-2xl glass-panel border border-accent-primary/30 bg-accent-light/10 space-y-3">
        <h2 className="text-sm font-bold text-accent-primary flex items-center gap-2">
          <Icon icon="ph:globe-bold" className="w-5 h-5" />
          Base API v1 Endpoint
        </h2>
        <div className="p-3.5 rounded-xl bg-code-bg font-mono text-xs font-bold text-emerald-400 select-all border border-border-theme">
          {config.apiUrl}
        </div>
        <p className="text-xs text-text-secondary leading-relaxed">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-extrabold text-text-primary">Core Architectural Pillars</h2>
      ...
      <div className="space-y-4 pt-4 border-t border-border-theme">
        <h2 className="text-xl font-extrabold text-text-primary">Step-by-Step Implementation Guide</h2>
        <ol className="space-y-3 text-xs text-text-secondary list-decimal pl-5 leading-relaxed">
      ...
      <div className="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link
          href="/docs/posts"
          className="p-4 rounded-xl border border-border-theme bg-bg-secondary hover:border-accent-primary/50 transition-all text-xs font-semibold text-text-primary flex items-center justify-between group"
        >
